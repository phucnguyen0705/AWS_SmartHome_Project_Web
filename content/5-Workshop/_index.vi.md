...
| Bước | Nội dung |
|:---:|----------|
| [5.1 Giới thiệu](5.1-introduction/_index.vi.md) | Tổng quan dự án, stack, luồng deploy |
| [5.2 Chuẩn bị AWS](5.2-prerequisites/_index.vi.md) | Region, IAM, VPC, EC2 Key Pair |
| [5.3 AWS IoT Core](5.3-iot-core/_index.vi.md) | Policy, Thing, Certificate, Endpoint |
| [5.4 CloudFormation](5.4-cloudformation/_index.vi.md) | Deploy stack hạ tầng (EC2, DynamoDB, Cognito, CloudWatch) |
| [5.5 Kiểm tra hạ tầng](5.5-verify-infrastructure/_index.vi.md) | Xác nhận tài nguyên trên Console |
| [5.6 Deploy ứng dụng](5.6-deploy-application/_index.vi.md) | Cấu hình `.env`, upload code lên EC2, Nginx + PM2 |
| [5.7 Tài khoản Cognito](5.7-cognito-users/_index.vi.md) | Tạo user demo `admin`, `user1`, `user2` |
| [5.8 Kiểm tra & Demo](5.8-verification-demo/_index.vi.md) | Health check, đăng nhập, điều khiển thiết bị |
| [5.9 ESP32 thật (tuỳ chọn)](5.9-optional-esp32/_index.vi.md) | Flash firmware, dùng cert device |
| [5.10 Dọn dẹp & xử lý lỗi](5.10-cleanup-troubleshooting/_index.vi.md) | Xóa stack, reset, bảng troubleshooting |
